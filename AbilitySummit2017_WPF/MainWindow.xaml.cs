...
namespace AbilitySummit2017_WPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void LiveRegionButton_Click(object sender, RoutedEventArgs e)
        {
            UIElementAutomationPeer.FromElement(LiveRegionText)?.RaiseAutomationEvent(AutomationEvents.LiveRegionChanged);
        }
    }
}